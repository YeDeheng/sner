...
for i in {0..9}
do
	python featureextractor.py ./train_eval/allconllfile-oct27-noPL/train$i.conll ./train_eval/train$i.data
	python featureextractor.py ./train_eval/allconllfile-oct27-noPL/test$i.conll ./train_eval/test$i.data
done
cd ./train_eval/allconllfile-oct27-noPL
